...
- [ ] Create `src/components/TimelineChart.tsx` with the following structure:
...
- [ ] Commit: `git add src/components/TimelineChart.tsx && git commit -m "feat: add TimelineChart component with Recharts stacked bars"`
